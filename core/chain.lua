...
--
--   genesis    = H(session_id ^ char_guid ^ schema_version)
...
function Chain.genesis(session_id, char_guid, schema_version)
	return Hash.fnv1a(session_id .. "^" .. char_guid .. "^" .. schema_version)
end
